...
func _on_button_menor_pressed():
	if number1 < number2:
		...
		Mensaje.text = str("¡Correcto! " + str(number1) + " es menor que " + str(number2))
	else:
		#Creamos la variable mensaje
		Mensaje = Label.new()
		Mensaje.set_align(Label.ALIGN_CENTER)
		...
		#posicion del mensaje
		Mensaje.rect_position = Vector2(10, 100)
		Mensaje.text = str("¡Incorrecto! " + str(number1) + " no es menor que " + str(number2))
	generateNumbers()
...
func _on_button_igual_pressed():
	if number1 == number2:
		...
		#posicion del mensaje
		Mensaje.rect_position = Vector2(10, 100)
		Mensaje.text = str("¡Correcto! " + str(number1) + " es igual a " + str(number2))
	else:
		#Creamos la variable mensaje
		Mensaje = Label.new()
		Mensaje.set_align(Label.ALIGN_CENTER)
		...
		#posicion del mensaje
		Mensaje.rect_position = Vector2(10, 100)
		Mensaje.text = str("¡Incorrecto! " + str(number1) + " no es igual a " + str(number2))
	generateNumbers()
...
func _on_button_mayor_pressed():
	if number1 > number2:
		...
		#posicion del mensaje
		Mensaje.rect_position = Vector2(10, 100)
		Mensaje.text = str("¡Correcto! " + str(number1) + " es mayor que " + str(number2))
	else:
		#Creamos la variable mensaje
		Mensaje = Label.new()
		Mensaje.set_align(Label.ALIGN_CENTER)
		...
		#posicion del mensaje
		Mensaje.rect_position = Vector2(10, 100)
		Mensaje.text = str("¡Incorrecto! " + str(number1) + " no es mayor que " + str(number2))
	generateNumbers()
